...
<div align="left">
    <img align="right" alt="Coding Gif" height="300" style="border-radius:50px;" src="https://media.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif">

    ### Sobre mim
    
    🔭 Atualmente estou trabalhando em **[Nome do Projeto/Empresa]**
    <br/>
    🌱 Estou aprendendo **Arquitetura de Software e Java**
    <br/>
    👯 Procuro colaborar em **Projetos Open Source**
    <br/>
    ⚡ Curiosidade: **Eu amo café e resolver bugs complexos**
    <br/>
    <br/>
